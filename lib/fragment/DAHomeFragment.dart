...
import '../components/DiscoverBottomSheetWidget.dart';
import '../model/DatingAppModel.dart';
import '../screen/DAZoomingScreen.dart';
...
class DAHomeFragment extends StatefulWidget {
  const DAHomeFragment({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget(
        ...
        showBack: false,
        actions: [
          const Icon(Icons.sort,color: primaryColor,).paddingOnly(right: 16).onTap(() {
            showModalBottomSheet(
              shape: const RoundedRectangleBorder(borderRadius: BorderRadius.only(topLeft: Radius.circular(16), topRight: Radius.circular(16))),
              context: context,
              builder: (BuildContext context) {
                return const DiscoverBottomSheetWidget();
              },
            );
          }),
        ],
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.clear, color: white, size: 30),
                        ).onTap(() {
