...
import '../screen/PurchaseMoreScreen.dart';
import 'DAConstants.dart';
...
List<DatingAppModel> getIdealList() {
  List<DatingAppModel> list = [];
  list.add(DatingAppModel(name: 'Love', widget: const Icon(Icons.favorite_border, color: white), color: redColor.withOpacity(0.7)));
